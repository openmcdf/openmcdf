...
internal static class ThrowHelper
{
    ...
    public static void ThrowIfSeekBeyondMaximumLength(long value, long maxLength, string paramName)
    {
        if (value > maxLength)
            throw new ArgumentOutOfRangeException(paramName, "An attempt was made to move the position beyond the maximum length of the stream.");
    }
